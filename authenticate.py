...
class Websites:
    ...
    def get_linkedin(self):
        ...
        messaging = self.driver.find_element_by_class_name('msg-overlay-bubble-header__button')
        messaging.click()
        friend = self.driver.find_element_by_class_name('msg-conversation-card__row')
        friend.click()
        message = self.driver.find_element_by_class_name('msg-form__contenteditable')
        message.send_keys('Automated test message. Sent through a Python module using Selenium library.')
